...
[Source](https://code.visualstudio.com/docs/editor/tasks-appendix)

The hope is to use as much of this specification as possible. There will need to be tweaks to make it command-line friendly and other concerns.
